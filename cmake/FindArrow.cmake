...
find_library(LIBAWS_C_COMMON_LIBRARY NAMES aws-c-common
        HINTS ${AWS_LIB_DIR})
find_library(LIBAWS_C_EVENT_STREAM_LIBRARY NAMES aws-c-event-stream
        HINTS ${AWS_LIB_DIR})
...
set_property(TARGET aws::aws PROPERTY INTERFACE_LINK_LIBRARIES  ${LIBAWS_S3_LIBRARY} ${LIBAWS_CORE_LIBRARY} ${LIBAWS_C_EVENT_STREAM_LIBRARY}
        ${LIBAWS_C_COMMON_LIBRARY} ${LIBAWS_CHECKSUM_LIBRARY} ${LIBAWS_IAM_LIBRARY} ${LIBAWS_STS_LIBRARY})
